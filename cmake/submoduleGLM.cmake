message ("${SUBMODULES_INSTALL_DIRECTORY}")
...
if( MSCV )
    ...
    set ( glm_headers "${CMAKE_CURRENT_SOURCE_DIR}/external/OpenGL/glm/glm")

    add_custom_target(glm
        FILE (COPY ${glm_headers} DESTINATION ${SUBMODULES_INSTALL_DIRECTORY}/include)
    )
else ()
...
ExternalProject_Add(
        ...
        SOURCE_DIR "${CMAKE_CURRENT_SOURCE_DIR}/external/OpenGL/glm"

        # override default behaviours
        UPDATE_COMMAND ""

        GIT_SUBMODULES external/OpenGL/glm
